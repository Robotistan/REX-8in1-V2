...
There is a port for connecting and 1 buzzer and switch integrated into the card, 4 motor driver and servo motor connectors for making the installation of 8 in 1 robots and circuit designs easier on the REX card, 1 connection connector for each of the HC-SR04, TCRT5000 and MPU6050 sensors, a 12V battery for external circuit There is a port for connecting and 1 buzzer and switch integrated into the card.
